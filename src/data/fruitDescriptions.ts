import { FruitDescriptions } from "./types";
...
export const fruitDescriptions: FruitDescriptions = {
  Tangerine:
  ...
  Pear: "Pears are sweet and juicy fruits with a distinctive bell-like shape and smooth skin that can range in color from green to yellow to red. They have a delicate, floral flavor with a hint of sweetness and subtle grainy texture. Pears can be enjoyed fresh or used in desserts, salads, and savory dishes.",
  ...
  Dragon:
    ...
    "Dragon fruit is packed with essential vitamins and minerals. It is a good source of vitamin C, antioxidants, iron, and magnesium, which are important for overall health and well-being.",
