      ...
      <div className={styles.main}>
        ...
        <div className={styles.rightContainer}>
          <div className={styles.checkout}>
            ...
            <form className='mt-5'>
            <script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_GQkoLlvzl4qAYP" async> </script> 
        </form>
            <ButtonBlue className={styles.checkoutButton} onClick={() => RazorpayForm()} />
          </div>
        </div>
      </div>
    </div>
